...
public class Images {
    ...
    public static BufferedImage[] galagaEnemyGoei;
    ...
    public Images() {
        ...
        galagaEnemyGoei = new BufferedImage[8];
        ...
        try {
            ...
            galagaEnemyGoei[0] = galagaSpriteSheet.crop(188,178-22,9,10);
            galagaEnemyGoei[1] = galagaSpriteSheet.crop(162,178-22,13,10);
            galagaEnemyGoei[2] = galagaSpriteSheet.crop(139,177-22,11,12);
            galagaEnemyGoei[3] = galagaSpriteSheet.crop(113,176-22,14,13);
            galagaEnemyGoei[4] = galagaSpriteSheet.crop(90,177-22,13,13);
            galagaEnemyGoei[5] = galagaSpriteSheet.crop(65,176-22,13,14);
            galagaEnemyGoei[6] = galagaSpriteSheet.crop(42,178-22,12,11);
            galagaEnemyGoei[7] = galagaSpriteSheet.crop(19,177-22,10,13);
